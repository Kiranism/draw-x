...
import { DrawOptions, JoinRoomData, NextApiResponseServerIo } from '@/types/index'
import { addUser, getRoomMembers, getUser, removeUser } from '@/lib/data/users'
import { z } from 'zod'
  ...
  if (!res.socket.server.io) {
    ...
    io.on('connection', socket => {
      ...
      socket.on('create-room', (joinRoomData: JoinRoomData) => {
        console.log('connected create-room')
